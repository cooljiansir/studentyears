...
public class ProcessImg {
	 ...
	 * 
	 */
	public ProcessImg(String fromFileStr, String saveToFileStr, String sysimgfile,String suffix,int width,int height) {
	...
	public static void main(String[] args) {
		...
		boolean ss = false;
		try {
			UI = new ProcessImg("e://1.jpg", "e://temp", "ps_low1","png",100,100);
