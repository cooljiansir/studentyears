...
%>
			<li ><a href="#">欢迎<%=session.getAttribute("username")%><span class="sr-only">(current)</span></a></li>
<%
      }
%>
			<li><a href="../navbar/"><span class="divider"></span></a></li>
			...
			<form class="form-horizontal " action="multiupload.action" method="post" id="releaseForm" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
				<div class="col-sm-offset-2 col-sm-10">
				  <button id="releaseBut" type="submit" class="btn btn-default">发布</button>
				</div>
...
<script type="text/javascript" ><!--
	...
	/*$("#releaseCommitBut").click(function(){
		alert("debug");
		$.ajax({     
